...
CREATE TABLE entrega_epi (
    ...
    -- NOVO: funcionário solicitou devolução
    solicitou_devolucao BIT DEFAULT 0,


    -- NOVO: gestão recebeu o EPI
    recebido_pela_gestao BIT DEFAULT 0,


    -- NOVO: avaliação da devolução
    estado_epi VARCHAR(50),

    destino_epi VARCHAR(50),

    observacao_devolucao VARCHAR(500)
...
(data_entrega,data_devolucao,aceito,fk_usuario_id_usuario,solicitou_devolucao)
VALUES
('2026-04-01','2026-10-01',0,3,0),
('2026-04-02','2026-10-02',0,4,0),
('2026-04-03','2026-10-03',0,5,0),
('2026-04-04','2026-10-04',0,3,0),
('2026-04-05','2026-10-05',0,4,0);
...
(fk_EPI_id_epi,fk_entrega_epi_id_entrega_epi,Quantidade)
VALUES
(1,1,2),
(2,1,1),
(3,1,3),
